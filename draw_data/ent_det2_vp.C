...
TFile *P1dfile =new TFile("test_komac_108_2.root", "read");
  ...
  // TH1D *KE_e_over = new TH1D("e_KE_over", "electron_KE dist_over 1847", 30,0,1);
  ...
  // c3->cd(2)->SetLogy();
  // c3->cd(3)->SetLogy();
    std::cout <<"world made " <<world_vp<< "\n";
    std::cout <<"other made: " <<other_vp<< "\n";
// c3->cd(1);
