  ...
  TH2D *hist_side4 = new TH2D("hist_side4_my", "KE of side4", 50, 1817, 1877, 50, 17,226);
   ...
   for (j=0;j<Entry_KE; j++){
     ...
     //if(strcmp(vpvol, "Al_Shield") == 0){
      ...
      if(abs(posz -1872)<0.0000000000000000001) {
          s_z += 1;
          hist_front->Fill(posx, posy);

      } else if(abs(posz -1822)<0.0000000000000000001) {
          s_mz += 1;
          hist_back->Fill(posx, posy);

      } else if(abs(posy-100)<0.00000000000000000001) {
          s_y += 1;
      ...
      } else if(abs(posx-100)<0.000000000000001) {
          s_mx += 1;
          hist_side3->Fill(posz, posy);
                    if(posz<1840){
            side3_under1840 +=1;
          }
      } else if(abs(posx-0)<0.00001) {
          s_x += 1;
...
int i;
TH1F *h = new TH1F("gamma", "exit surface of Gamma", nx,0,nx);
