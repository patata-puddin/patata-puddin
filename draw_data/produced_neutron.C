...
TFile *P1dfile =new TFile("test_4.root", "read");
  ...
  TTree *TVol1 = (TTree *) P1dfile -> Get("made_shield_neutron");
  ...
  TH2D *hist_22_vposxz = new TH2D("vp_neutron_shield_xz", "vp of neutron(x,z)_made in Shield", 50, 17, 226, 50, 1817, 1877);
  TH2D *hist_22_vposxy = new TH2D("vp_neutron_shield_xy", "vp of neutron(x,y)_made in Shield", 50, 17, 226, 50, -80, 130);
  TH2D *hist_22_vpos_E = new TH2D("vp_neutron_shield_E", "vp - KE of neutron ", 50, 1817, 1877, 50, 0, 14);
    TH1D *hist_sh_22_phiangle = new TH1D("neutron_phi", "Angle (phi) of neutron produced shield", 60, -2, 362);
    TH1D *hist_sh_22_thetaangle = new TH1D("neutron_theta", "Angle (theta) of neutron exiting shield", 60, -2, 182);
    TH2D *theta_22_KE = new TH2D("neutron_theta_KE", "neutron KE of theta", 50, -5, 185, 60, 0, 15);
...
cout << "#of neutron: " << neutroncount << endl;
...
if(hist_22_vpos_E != nullptr){
  ...
  hist_22_vpos_E->Draw("colz");
    ...
    if (hist_sh_22_thetaangle != nullptr)
    {
        ...
        hist_sh_22_thetaangle->SetTitle("theta angle of neutron produced shield");
