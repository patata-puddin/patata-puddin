...
// TH1D *KE_below = new TH1D("KE_below", "KE of below", 50, 0, 20);
  ...
  TH2D *hist_front = new TH2D("hist_front", "KE of front", 50, 17, 226, 50, 0,30);
  TH2D *hist_back = new TH2D("hist_back", "KE of back", 50, 17, 226, 50, 0,30);
  TH2D *hist_side1 = new TH2D("hist_side1_x", "KE of side1", 50, 1817, 1877, 50, 0,30);
  TH2D *hist_side2 = new TH2D("hist_side2_y", "KE of side2", 50, 1817, 1877, 50, 0,30);
  TH2D *hist_side3 = new TH2D("hist_side3_mx", "KE of side3", 50, 1817, 1877, 50, 0,30);
  TH2D *hist_side4 = new TH2D("hist_side4_my", "KE of side4", 50, 1817, 1877, 50, 0,30);
   ...
   for (j=0;j<Entry_KE; j++){
      ...
      if(posz == 1872) {
          s_z += 1;
          hist_front->Fill(posx, KE);

      } else if(posz == 1822) {
          s_mz += 1;
          hist_back->Fill(posx, KE);

      } else if(abs(posy-125)<0.000000001) {
          s_y += 1;
          hist_side2->Fill(posz, KE);
          if(posz<1840){
            side2_under1840 +=1;
          }
      } else if(abs(posy+75)<0.000000001) {
          s_my += 1;
          hist_side4->Fill(posz, KE);
                    if(posz<1840){
            side4_under1840 +=1;
          }
      } else if(abs(posx-21.25)<0.000000001) {
          s_mx += 1;
          hist_side3->Fill(posz, KE);
                    if(posz<1840){
            side3_under1840 +=1;
          }
      } else if(abs(posx-221.25)<0.000000001) {
          s_x += 1;
          hist_side1->Fill(posz, KE);
                    if(posz<1840){
            side1_under1840 +=1;
          }
      } else {exception +=1;
...
// cout << "in proton  " << protoncount << endl;
...
// int i;
// TH1F *h = new TH1F("proton", "exit surface of proton", nx,0,nx);
...
TCanvas* c1 = new TCanvas("c1", "KE comparision", 20, 20, 1000, 1000);
 ...
 c1->cd(4);
    if (hist_side2 != nullptr)
    {
        ...
        hist_side2->GetYaxis()->SetTitle("KE (MeV)");
        hist_side2->SetFillColorAlpha(kGreen + 3, 0.9);
        hist_side2->SetLineColor(kGreen + 3);
        hist_side2->SetFillStyle(3004);
        hist_side2->SetMaximum(200);
        // hist_sh_22_thetaangle_x->SetMinimum(1);
        hist_side2->SetTitle("hist of proton at surface -SIDE 2");
        // x_hist_DAQ_2212_KE->SetFillColorAlpha(4,0.1);
 ...
 c1->cd(5);
    if (hist_side3 != nullptr)
    {
        ...
        hist_side3->GetYaxis()->SetTitle("KE (MeV)");
        hist_side3->SetFillColorAlpha(kGreen + 3, 0.9);
        hist_side3->SetLineColor(kGreen + 3);
        hist_side3->SetFillStyle(3004);
        hist_side3->SetMaximum(200);
        // hist_sh_22_thetaangle_x->SetMinimum(1);
        hist_side3->SetTitle("hist of proton at surface -SIDE 3");
        // x_hist_DAQ_2212_KE->SetFillColorAlpha(4,0.1);
 ...
 c1->cd(6);
    if (hist_side4 != nullptr)
    {
        ...
        hist_side4->GetYaxis()->SetTitle("KE (MeV)");
        hist_side4->SetFillColorAlpha(kGreen + 3, 0.9);
        hist_side4->SetLineColor(kGreen + 3);
        hist_side4->SetFillStyle(3004);
        hist_side4->SetMaximum(200);
        // hist_sh_22_thetaangle_x->SetMinimum(1);
        hist_side4->SetTitle("hist of proton at surface -SIDE 4");
        // x_hist_DAQ_2212_KE->SetFillColorAlpha(4,0.1);
