...
TFile *P1dfile =new TFile("test_2.root", "read");
  ...
  TTree *TVol1 = (TTree *) P1dfile -> Get("ext_shield_neutron");
  ...
  TH1D *hist_22_vposz = new TH1D("vp_neutron_shield_z", "vp of neutron exiting shield_made in Shield", 50, 1817, 1877);
  
  TH2D *hist_22_vposxz = new TH2D("vp_neutron_shield_xz", "vp of neutron(x,z) exiting shield_made in Shield", 50, 17, 226, 50, 1817, 1877);
  TH2D *hist_22_vposxy = new TH2D("vp_neutron_shield_xy", "vp of neutron(x,y) exiting shield_made in Shield", 50, 17, 226, 50, -80, 130);

  TH2D *hist_length = new TH2D("vp_length", "vp (z) of neutron - travel length", 100, 1817, 1877, 200, 0.0005, 400);
  TH2D *hist_len_front = new TH2D("vp_len_front", "vp (z) of neutron - travel len_FRONT", 100, 1817, 1877, 200, 0.0005, 400);
  TH2D *hist_len_back = new TH2D("vp_len_back", "vp (z) of neutron - travel len_BACK", 100, 1817, 1877, 200, 0.0005, 400);
  TH2D *hist_len_side1 = new TH2D("vp_len_side1", "vp (z) of neutron - travel len_side1", 100, 1817, 1877, 200, 0.0005, 400);
  TH2D *hist_len_side2 = new TH2D("vp_len_side2", "vp (z) of neutron - travel len_side2", 100, 1817, 1877, 200, 0.0005, 400);
  TH2D *hist_len_side3 = new TH2D("vp_len_side3", "vp (z) of neutron - travel len_side3", 100, 1817, 1877, 200, 0.0005, 400);
  TH2D *hist_len_side4 = new TH2D("vp_len_side4", "vp (z) of neutron - travel len_side4", 100, 1817, 1877, 200, 0.0005, 400);
...
cout << "#of neutron: " << gammacount << endl;
cout << "#of exception: " << exception << endl;
cout << "#of neutron produced at z<1826: " << under1826count << endl;
cout << "#of neutron produced at  1826 < z<1828: " << under1828count << endl;
...
if(hist_22_vposz != nullptr){
  ...
  hist_22_vposz->SetTitle("Position (z) of neutron produced in shield");
...
if(hist_front != nullptr){
  ...
  hist_front->SetTitle("Position (z) of neutron produced in shield_FRONT");
...
if(hist_back != nullptr){
  ...
  hist_back->SetTitle("Position (z) of neutron produced in shield_BACK");
...
if(hist_side3 != nullptr){
  ...
  hist_side3->SetTitle("Position (z) of neutron produced in shield_SIDE3");
...
if(hist_side1 != nullptr){
  ...
  hist_side1->SetTitle("Position (z) of neutron produced in shield_SIDE1");
...
if(hist_side2 != nullptr){
  ...
  hist_side2->SetTitle("Position (z) of neutron produced in shield_SIDE2");
...
if(hist_side4 != nullptr){
  ...
  hist_side4->SetTitle("Position (z) of neutron produced in shield_SIDE4");
...
if(hist_22_vposxz != nullptr){
  ...
  hist_22_vposxz->SetTitle("Position (x, z) of neutron produced in shield");
...
if(hist_22_vposxy != nullptr){
  ...
  hist_22_vposxy->SetTitle("Position (x, y) of neutron produced in shield");
  // hist_22_vposxz->SetMaximum(1000);
  //x_hist_AQ_2212_KE->SetFillColorAlpha(4,0.1);
...
//----------graph draw ----------------------------------
    ...
    c1->cd(1);
    auto g = new TGraph(gammacount, &vp_z_vec[0], &tracklen_vec[0]);
...
//Draw multigraph of x side
   ...
   TMultiGraph *mg_fb = new TMultiGraph();
    ...
    mg_fb->SetMaximum(400);
    mg_fb->SetMinimum(0.0005);
    mg_fb->Draw("AP");
