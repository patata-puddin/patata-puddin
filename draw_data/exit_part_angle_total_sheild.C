...
void exit_part_angle_total_sheild()
{
    // gROOT->Reset();
  ...
  Double_t mom_zp, mom_zg, mom_zn;
    ...
    TH1D *hist_sh_2212_phiangle = new TH1D("Proton_phi", "phi of Proton exiting_made shield", 60, -2, 362);
    TH1D *hist_sh_2212_thetaangle = new TH1D("Proton_theta", "theta of Proton exiting_made shield", 60, -2, 182);

    TH1D *hist_sh_22_phiangle = new TH1D("Gamma_phi", "phi of gamma exiting_made shield", 60, -2, 362);
    TH1D *hist_sh_22_thetaangle = new TH1D("Gamma_theta", "theta of gamma exiting_made shield", 60, -2, 182);

    TH1D *hist_sh_2112_phiangle = new TH1D("Neutron_phi", "phi of neutron exiting_made shield", 60, -2, 362);
    TH1D *hist_sh_2112_thetaangle = new TH1D("Neutron_theta", "theta of neutron exiting_made shield", 60, -2, 182);

    TH2D *theta_2212_KE = new TH2D("Proton_theta_KE", "KE of theta_made shield", 50, -5, 185, 60, 0, 30);
    TH2D *phi_2212_KE = new TH2D("Proton_phi_KE", "KE of phi_made shield", 50, -5, 365, 60, 0, 30);

    TH2D *theta_22_KE = new TH2D("Gamma_theta_KE", "KE of theta_made shield", 50, -5, 185, 60, 0, 15);
    TH2D *phi_22_KE = new TH2D("Gamma_phi_KE", "KE of phi_made shield", 50, -5, 365, 60, 0, 15);

    TH2D *theta_2112_KE = new TH2D("Neutron_theta_KE", "KE of theta_made shield", 50, -5, 185, 60, 0, 15);
    TH2D *phi_2112_KE = new TH2D("Neutron_phi_KE", "KE of phi_made shield", 50, -5, 365, 60, 0, 15);
...
//angle plot
    ...
    if (hist_sh_2212_thetaangle != nullptr)
    {
        ...
        hist_sh_2212_thetaangle->SetMaximum(2000);
    ...
    if (hist_sh_2112_thetaangle != nullptr)
    {
        ...
        // hist_sh_2112_thetaangle->SetMaximum(10000);
        // hist_sh_22_thetaangle_x->SetMinimum(1);
        // x_hist_DAQ_2212_KE->SetFillColorAlpha(4,0.1);
