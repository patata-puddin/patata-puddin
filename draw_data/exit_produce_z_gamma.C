...
void exit_produce_z_gamma()
{

TFile *P1dfile =new TFile("please.root", "read");

  //Proton made in shield, exiting shield


  TTree *TVol1 = (TTree *) P1dfile -> Get("ext_shield_gamma");
  ...
  TH1D *hist_22_vposz = new TH1D("vp_gamma_shield_z", "vp of gamma exiting shield_made in Shield", 50, 1817, 1877);
  
  TH2D *hist_22_vposxz = new TH2D("vp_gamma_shield_xz", "vp of gamma(x,z) exiting shield_made in Shield", 50, 17, 226, 50, 1817, 1877);
  TH2D *hist_22_vposxy = new TH2D("vp_gamma_shield_xy", "vp of gamma(x,y) exiting shield_made in Shield", 50, 17, 226, 50, -80, 130);

  TH2D *hist_length = new TH2D("vp_length", "vp (z) of gamma - travel length", 100, 1817, 1877, 200, 0.0005, 400);
  TH2D *hist_len_front = new TH2D("vp_len_front", "vp (z) of gamma - travel len_FRONT", 100, 1817, 1877, 200, 0.0005, 400);
  TH2D *hist_len_back = new TH2D("vp_len_back", "vp (z) of gamma - travel len_BACK", 100, 1817, 1877, 200, 0.0005, 400);
  TH2D *hist_len_side1 = new TH2D("vp_len_side1", "vp (z) of gamma - travel len_side1", 100, 1817, 1877, 200, 0.0005, 400);
  TH2D *hist_len_side2 = new TH2D("vp_len_side2", "vp (z) of gamma - travel len_side2", 100, 1817, 1877, 200, 0.0005, 400);
  TH2D *hist_len_side3 = new TH2D("vp_len_side3", "vp (z) of gamma - travel len_side3", 100, 1817, 1877, 200, 0.0005, 400);
  TH2D *hist_len_side4 = new TH2D("vp_len_side4", "vp (z) of gamma - travel len_side4", 100, 1817, 1877, 200, 0.0005, 400);
...
if(hist_22_vposz != nullptr){
  ...
  hist_22_vposz->SetTitle("Position (z) of gamma produced in shield");
...
if(hist_front != nullptr){
  ...
  hist_front->SetTitle("Position (z) of gamma produced in shield_FRONT");
...
if(hist_back != nullptr){
  ...
  hist_back->SetTitle("Position (z) of gamma produced in shield_BACK");
...
if(hist_side3 != nullptr){
  ...
  hist_side3->SetTitle("Position (z) of gamma produced in shield_SIDE3");
...
if(hist_side1 != nullptr){
  ...
  hist_side1->SetTitle("Position (z) of gamma produced in shield_SIDE1");
...
if(hist_side2 != nullptr){
  ...
  hist_side2->SetTitle("Position (z) of gamma produced in shield_SIDE2");
...
if(hist_side4 != nullptr){
  ...
  hist_side4->SetTitle("Position (z) of gamma produced in shield_SIDE4");
