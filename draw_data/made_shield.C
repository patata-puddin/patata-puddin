...
TCanvas* c1 = new TCanvas("c1", "Histogram of Entering Particle in shield", 20, 20, 2000, 2000);
  ...
  TTree *TVol1 = (TTree *) P1dfile -> Get("made_shield");
  TVol1 -> Draw("name>>h1","","");
...
int exception = 0;
  ...
  TVol2 -> SetBranchAddress("name",&name);


  TH1D *hist_sh_2212_KE = new TH1D("Proton", "Proton Energy entering shield", 100, 0, 30);
  TH1D *hist_sh_22_KE = new TH1D("Gamma", "Gamma Energy entering shield", 40, 0, 15);
  TH1D *hist_sh_2112_KE = new TH1D("Neutron", "Neutron Energy entering shield", 40, 0, 20);
  ...
  auto Entry_KE = TVol2->GetBranch("name")->GetEntries() ;
...
c2->cd(1);
  ...
  hist_sh_2212_KE->SetMaximum(3000000);
  hist_sh_2212_KE->SetTitle("E dist of PROTON made shield");
...
c2->cd(2);
  ...
  hist_sh_22_KE->SetTitle("E dist of GAMMA made shield");
  //x_hist_DAQ_2212_KE->SetFillColorAlpha(4,0.1);
  hist_sh_22_KE->Draw();
...
c2->cd(3);
  ...
  hist_sh_2112_KE->SetTitle("E dist of NEUTRON made shield");
  //x_hist_DAQ_2212_KE->SetFillColorAlpha(4,0.1);
