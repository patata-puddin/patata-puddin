...
//   gPad->SetLogy();
  ...
  TTree *TVol2 = (TTree *) P1dfile -> Get("Detector_4");
  Double_t sh_KE;
  Double_t sh_Pdg;
  ...
  // TH3D *hist_sh_2212_KE = new TH3D("Proton_KE", "Proton Energy entering detector4", 100, -225, 225 , 100, -225, 225, 10, 0, 30);
  // TH3D *hist_sh_22_KE = new TH3D("Gamma_KE", "Gamma Energy entering detector4", 100, -225, 225 , 100, -225, 225, 10, 0, 30);
  // TH3D *hist_sh_2112_KE = new TH3D("Neutron_KE", "Neutron Energy entering detector4", 100, -225, 225 , 100, -225, 225, 10, 0, 30);

  TH2D *hist_2212 = new TH2D("Proton", "Proton entering detector4", 100, 1622, 2072 , 100, -225, 225);
  TH2D *hist_22 = new TH2D("Gamma", "Gamma entering detector4", 100, 1622, 2072 , 100, -225, 225);
  TH2D *hist_2112 = new TH2D("Neutron", "Neutron entering detector4", 100, 1622, 2072 , 100, -225, 225);
