...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
  ...
  auto AlBox1_pos =G4ThreeVector(-208*mm, 22*mm, 1860*mm);
  auto AlBox2_pos =G4ThreeVector(-274.5*mm, 169.5*mm, 1860*mm); //윗면
  auto AlBox21_pos =G4ThreeVector(-274.5*mm, -125.5*mm,  1860*mm); //아랫면
  auto AlBox3_pos =G4ThreeVector(-277*mm, 22*mm, 1932.5*mm); //옆면
  auto AlBox31_pos =G4ThreeVector(-277*mm, 22*mm, 1787.5*mm); //옆면
  auto AlBox4_pos =G4ThreeVector(-341*mm, 22*mm, 1860*mm); //뒷면

auto Det2_pos=G4ThreeVector(-231.5*mm, 22*mm, 1860*mm);
...
// auto Al_l_pos =G4ThreeVector(142*mm, 50*mm, 1842*mm);
  ...
  rot3->rotateX(90.0 * deg);
  rot3->rotateY(90.0 * deg);
