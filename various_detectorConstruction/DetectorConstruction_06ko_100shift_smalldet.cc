...
auto Shield1_pos=G4ThreeVector(-20*mm, 0*mm, 1647*mm);
// auto Shield_pos_di=G4ThreeVector(0*mm, 0*mm, 1897.5*mm);
auto Shield2_pos=G4ThreeVector(-95*mm, 0*mm, 1900*mm);
auto Shield21_pos=G4ThreeVector(-95*mm, 0*mm, 2001*mm);
auto Shield3_pos=G4ThreeVector(-150*mm, 0*mm, 1824*mm);
auto Shield4_pos=G4ThreeVector(-150*mm, 0*mm, 1773*mm);
// auto Shield5_pos=G4ThreeVector(-226*mm, 0*mm, 1699*mm);

// auto Det1_pos=G4ThreeVector(0*mm, 0*mm, 2067*mm);
auto Det2_pos=G4ThreeVector(-220*mm, 0*mm, 2000*mm);
