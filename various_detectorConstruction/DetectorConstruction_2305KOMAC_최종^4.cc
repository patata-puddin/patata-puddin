...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
  ...
  auto AlBox1_pos =G4ThreeVector(-208*mm, -49*mm, 1900*mm);
  auto AlBox2_pos =G4ThreeVector(-274.5*mm, -49*mm, 1752.5*mm); //옆면
  auto AlBox21_pos =G4ThreeVector(-274.5*mm, -49*mm, 2047.5*mm); //옆면
  auto AlBox3_pos =G4ThreeVector(-277*mm, 23.5*mm, 1900*mm); //윗면
  auto AlBox31_pos =G4ThreeVector(-277*mm, -121.5*mm, 1900*mm); //아랫면
  auto AlBox4_pos =G4ThreeVector(-341*mm, -49*mm, 1900*mm); //뒷면
...
auto Det2_pos=G4ThreeVector(-231.5*mm, -49*mm, 1900*mm);
...
// auto Al_l_pos =G4ThreeVector(142*mm, 50*mm, 1842*mm);
  ...
  auto Plas_pos =G4ThreeVector(-174*mm, -175*mm, 1786*mm);
  auto Plas2_pos =G4ThreeVector(150*mm, -175*mm, 1870*mm);
