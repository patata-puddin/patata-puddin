...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
  ...
  auto AlBox1_pos =G4ThreeVector(-205.5*mm, -24*mm, 1880*mm);
...
auto Shield2_pos=G4ThreeVector(-105*mm, -24*mm, 1850*mm);
...
auto Shield6_pos=G4ThreeVector(-156*mm, -24*mm, 1850*mm);
...
auto Det2_pos=G4ThreeVector(-230*mm, 0*mm, 1901*mm);
