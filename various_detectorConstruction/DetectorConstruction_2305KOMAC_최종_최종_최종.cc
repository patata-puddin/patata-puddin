...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
  ...
  auto AlBox1_pos =G4ThreeVector(-208*mm, -24*mm, 1900*mm);
  auto AlBox2_pos =G4ThreeVector(-274.5*mm, -24*mm, 1752.5*mm); //옆면
  auto AlBox21_pos =G4ThreeVector(-274.5*mm, -24*mm, 2047.5*mm); //옆면
  auto AlBox3_pos =G4ThreeVector(-277*mm, 48.5*mm, 1900*mm); //윗면
  auto AlBox31_pos =G4ThreeVector(-277*mm, -96.5*mm, 1900*mm); //아랫면
  auto AlBox4_pos =G4ThreeVector(-341*mm, -24*mm, 1900*mm); //뒷면
